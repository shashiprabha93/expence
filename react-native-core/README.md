...
If you want to roll on your own and don't want to use this as a template, you can create your own project and then copy the `/src` folder (which has all the code of your application) and update your `3DNavigator.js`.
...
- `src`: This folder is the main container of all the code inside your application.
  ...
  - `components`: Folder that contains all your application components.
    ...
    - `MyComponent`: Each component should be stored inside it's own folder, and inside it a file for its code and a separate one for the styles. Then, the `3DNavigator.js` is only used to export the final component that will be used on the app.
      - `MyComponent.js`
      - `styles.js`
      - `3DNavigator.js`
  - `helpers`: Folder to store any kind of helper that you have.
  - `reducers`: This folder should have all your reducers, and expose the combined result using its `3DNavigator.js`
...
- `3DNavigator.js`: Entry point of your application as per React-Native standards.
